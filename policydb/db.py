...
CREATE TABLE IF NOT EXISTS policies (
    ...
    policy_id       TEXT,             -- payer's MCG/policy number
...
def upsert_policy(conn: sqlite3.Connection, rec: dict) -> None:
    ...
    cols = [
        "source", "doc_key", "policy_id", "title", "subject", "file_type", "source_url",
        "effective_date", "revised_date", "page_count", "cpt_codes", "full_text",
        "content_hash", "extract_ok", "extract_error", "first_seen", "last_pulled",
    ]
